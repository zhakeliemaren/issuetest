          ...
          'list|1-3': [
            {
              ...
              type: 'OneWay',
              // 生成长度在 0~32 之间的小写字母
              github_branch: '@string("lower", 0, 32)',
              // 生成长度在 0~32 之间的小写字母
              gitee_branch: '@string("lower", 0, 32)',
              // 生成长度在 0~32 之间的小写字母
              gitlab_branch: '@string("lower", 0, 32)',
              // 生成长度在 0~32 之间的小写字母
              code_china_branch: '@string("lower", 0, 32)',
              // 生成长度在 0~32 之间的小写字母
              gitlink_branch: '@string("lower", 0, 32)',
              // 生成长度在 0~32 之间的小写字母
              commit: '@string("lower", 0, 32)',
              // 生成长度在 0~32 之间的小写字母
              base: '@string("lower", 0, 32)',
            },
          ],
        },
        // 生成长度在 0~32 之间的小写字母
...
module.exports = {
  'GET /cerobot/projects/:name/jobs': (req, res) => {
